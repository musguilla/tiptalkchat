  ...
  return (
    <main className="grid min-h-screen place-items-center bg-canvas p-6">
      ...
      <form onSubmit={submit} className="w-full max-w-sm space-y-5 rounded-lg border border-surface-container bg-white p-7 shadow-soft">
        <h1 className="font-display text-2xl font-extrabold tracking-tight">{t('es', 'auth.signup')}</h1>
        <label className="block space-y-1.5 text-sm">
          <span className="font-medium text-ink">{t('es', 'auth.displayName')}</span>
        ...
        <label className="block space-y-1.5 text-sm">
          <span className="font-medium text-ink">{t('es', 'auth.email')}</span>
        ...
        <label className="block space-y-1.5 text-sm">
          <span className="font-medium text-ink">{t('es', 'auth.password')}</span>
