      ...
      >
        <div className="flex items-center justify-between border-b border-surface-container px-5 py-4">
          <div className="flex items-center gap-3">
            ...
            <div className="min-w-0">
              <p className="text-xs text-ink-muted">Mensaje para</p>
        ...
        {sent ? (
          <div className="px-6 py-10 text-center">
            ...
            <h3 className="mt-4 font-display text-xl font-extrabold text-ink">¡Mensaje enviado!</h3>
            <p className="mt-2 text-sm text-ink-muted">
              {toName} recibirá un aviso por correo para que entre a responderte y podáis chatear.
            </p>
            <button
              type="button"
              onClick={onClose}
          ...
          <div className="p-5">
            ...
            <textarea
              ...
              maxLength={4000}
              autoFocus
              placeholder={`Escríbele a ${toName} para empezar a chatear…`}
